...
%><w:initPage name="auxiliar/janela/cadastro"><jsp:useBean
...
/><jsp:setProperty
  name="wipage" property="title" value="Cadastro de Janela de Acionamento"
...
<SCRIPT TYPE="text/javascript">
function init(){
var el = document.getElementsByTagName('SELECT')['tmp.edt.flg_janela_ativa'];
comboSelect(el,'<wi:out var="tmp.edt.flg_janela_ativa"/>');
}
</SCRIPT>
...
<td><INPUT NAME="tmp.edt.dsc_janela_descricao" ID="tmp.edt.dsc_janela_descricao" MAXLENGTH="150" SIZE="100" VALUE="<wi:out var="tmp.edt.dsc_janela_descricao"/>" CLASS="field required" /></td></tr></table>

<table cellpadding="0" cellspacing="0"><tr>
<td class="label_form">Ativa:</td>
</tr><tr>
<td><SELECT NAME="tmp.edt.flg_janela_ativa" ID="tmp.edt.flg_janela_ativa" CLASS="field required">
...
<table align="center">
  <tr>
    <td align="center" >
      ...
      <button type="button" name="tmp.btn_pesquisar" id="btn_pesquisar" role="button" class="botoes ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only" title="Clique no botão para pesquisar" alt="Clique no botão para pesquisar" onclick="wiOpen('/<wi:out var="wi.proj.id"/>/auxiliar/janela/pesquisa.wsp');">
