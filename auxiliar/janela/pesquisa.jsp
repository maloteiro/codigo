...
%><w:initPage name="auxiliar/janela/pesquisa"><jsp:useBean
...
/><jsp:setProperty
  name="wipage" property="title" value="Pesquisa de Janela de Acionamento"
						...
						<tr>
							<td>
								<div id="div_corpo">
                                  ...
                                  <div class="box">
                                      <center>                                        
										<FORM NAME="tmp.form" ACTION="/<wi:out var="wi.proj.id"/>/<wi:out var="wi.page.id"/>.wsp" METHOD="post" CLASS="frm" ><INPUT NAME="wi.page.prev" ID="wi.page.prev" VALUE="<wi:out var="wi.page.id"/>" TYPE="hidden" /><INPUT NAME="wi.token" ID="wi.token" VALUE="<wi:out var="wi.token"/>" TYPE="hidden" />
<table cellpadding="0" cellspacing="0"><tr>
<td class="label">Argumento de pesquisa:</td>
</tr><tr>
<td><INPUT NAME="tmp.argumento_pesquisa" ID="tmp.argumento_pesquisa" SIZE="50" VALUE="<wi:out var="tmp.argumento_pesquisa"/>" CLASS="field" /></td></tr></table>

<br/>
<table align="center">
  <tr>
    <td align="center" >      
      <button type="button" name="tmp.btn_add_novo" id="btn_add_novo" role="button" class="botoes ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only" title="Clique no botão para voltar" alt="Clique no botão para voltar" onclick="wiOpen('/<wi:out var="wi.proj.id"/>/auxiliar/janela/cadastro.wsp');">
        <span class="ui-button-text">Voltar</span>
      </button>
      <button type="submit" name="tmp.btn_pesquisar" id="btn_pesquisar" role="button" class="botoes ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only" title="Clique no botão para pesquisar" alt="Clique no botão para pesquisar">
...
<br>
<w:generateGrid name="aux_consulta_janela_acionamento"/>
