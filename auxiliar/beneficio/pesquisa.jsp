...
%><w:initPage name="auxiliar/beneficio/pesquisa"><jsp:useBean
...
/><jsp:setProperty
  name="wipage" property="title" value="Pesquisa de Beneficios"
...
<table align="center">
  <tr>
    <td align="center" >      
      <button type="button" name="tmp.btn_add_novo" id="btn_add_novo" role="button" class="botoes ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only" title="Clique no botão para voltar" alt="Clique no botão para voltar" onclick="wiOpen('/<wi:out var="wi.proj.id"/>/auxiliar/beneficio/cadastro.wsp');">
...
<br>
<w:generateGrid name="aux_consulta_beneficio"/>
