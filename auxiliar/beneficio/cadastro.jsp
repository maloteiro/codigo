...
%><w:initPage name="auxiliar/beneficio/cadastro"><jsp:useBean
...
/><jsp:setProperty
  name="wipage" property="title" value="Cadastro de Benefícios"
...
<SCRIPT TYPE="text/javascript">
function init(){
var el = document.getElementsByTagName('SELECT')['tmp.edt.flg_vaga_beneficio_ativa'];
comboSelect(el,'<wi:out var="tmp.edt.flg_vaga_beneficio_ativa"/>');
}
</SCRIPT>
...
<td><INPUT NAME="tmp.edt.dsc_vaga_beneficio_descricao" ID="tmp.edt.dsc_vaga_beneficio_descricao" MAXLENGTH="255" SIZE="60" VALUE="<wi:out var="tmp.edt.dsc_vaga_beneficio_descricao"/>" CLASS="field required" /></td></tr></table>

<table cellpadding="0" cellspacing="0"><tr>
<td class="label">Ativo:</td>
</tr><tr>
<td><SELECT NAME="tmp.edt.flg_vaga_beneficio_ativa" ID="tmp.edt.flg_vaga_beneficio_ativa" CLASS="field required">
...
<table align="center">
  <tr>
    <td align="center" >
      ...
      <button type="button" name="tmp.btn_pesquisar" id="btn_pesquisar" role="button" class="botoes ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only" title="Clique no botão para pesquisar" alt="Clique no botão para pesquisar" onclick="wiOpen('/<wi:out var="wi.proj.id"/>/auxiliar/beneficio/pesquisa.wsp');">
