...
/><jsp:setProperty
  name="updateelement1" property="sql" value="INSERT INTO aux_vaga_beneficio (
...
/><jsp:setProperty
  name="updateelement2" property="sql" value="UPDATE aux_vaga_beneficio
...
/><jsp:setProperty
  name="objectelement1" property="sql" value="SELECT aux_vaga_beneficio.seq_vaga_beneficio AS key1
 FROM aux_vaga_beneficio
 WHERE cod_token_codigo = ?|wi.token|
 ORDER BY aux_vaga_beneficio.seq_vaga_beneficio DESC"
/><jsp:setProperty
