...
/><jsp:setProperty
  name="updateelement1" property="sql" value="INSERT INTO aux_sistema (
...
/><jsp:setProperty
  name="updateelement2" property="sql" value="UPDATE aux_sistema
...
/><jsp:setProperty
  name="objectelement1" property="sql" value="SELECT aux_sistema.seq_sistema AS key1
 FROM aux_sistema
 WHERE cod_token_codigo = ?|wi.token|
 ORDER BY aux_sistema.seq_sistema DESC"
/><jsp:setProperty
