...
%><w:initPage name="auxiliar/sistema/cadastro"><jsp:useBean
...
/><jsp:setProperty
  name="wipage" property="title" value="Cadastro de Sistema Operacional"
...
<SCRIPT TYPE="text/javascript">
function init(){
var el = document.getElementsByTagName('SELECT')['tmp.edt.flg_sistema_ativo'];
comboSelect(el,'<wi:out var="tmp.edt.flg_sistema_ativo"/>');
}
</SCRIPT>
...
<td class="label_form">Descrição:</td>
</tr><tr>
<td><INPUT NAME="tmp.edt.dsc_sistema_descricao" ID="tmp.edt.dsc_sistema_descricao" MAXLENGTH="150" SIZE="100" VALUE="<wi:out var="tmp.edt.dsc_sistema_descricao"/>" CLASS="field required" /></td></tr></table>

<table cellpadding="0" cellspacing="0"><tr>
<td class="label_form">Ativa:</td>
</tr><tr>
<td><SELECT NAME="tmp.edt.flg_sistema_ativo" ID="tmp.edt.flg_sistema_ativo" CLASS="field required">
...
<table align="center">
  <tr>
    <td align="center" >
      ...
      <button type="button" name="tmp.btn_pesquisar" id="btn_pesquisar" role="button" class="botoes ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only" title="Clique no botão para pesquisar" alt="Clique no botão para pesquisar" onclick="wiOpen('/<wi:out var="wi.proj.id"/>/auxiliar/sistema/pesquisa.wsp');">
