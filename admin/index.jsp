            ...
            <div class="col-lg-6">
              <div class="info d-flex align-items-center">
                <div class="content">
                  ...
                  <p>Entrega fácil de documentos digitais</p>
                </div>
              </div>
            </div>
            <!-- Form Panel    -->
            <div class="col-lg-6 bg-white">
              <div class="form d-flex align-items-center">
                <div class="content">
                  ...
                  </form><a href="#" class="forgot-pass">Esqueceu a senha?</a><br><small>Não tem conta? </small><a href="register.html" class="signup">Signup</a>
                </div>
              </div>
            </div>
          </div>
