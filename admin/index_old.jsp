...
%><w:initPage name="admin/index_old"><jsp:useBean
						...
						<tr>
							<td>
								<div id="div_corpo">
                                  ...
                                  <div class="box">
                                      <center>
										<FORM NAME="frm" ACTION="/<wi:out var="wi.proj.id"/>/admin/home.wsp" METHOD="post" ONSUBMIT="return encodePass()"  style = 'display:inline'><INPUT NAME="wi.page.prev" ID="wi.page.prev" VALUE="<wi:out var="wi.page.id"/>" TYPE="hidden" />
<br />
<table cellpadding="0" cellspacing="0" border="0" class="login_box">
			...
			<tr valign="top">
				...
				<td align="center" width="295px" class="login_box_d_txt_center">
                        ...
                        <button type="button" name="bt_esqueci" id="bt_esqueci" onclick="wiOpen('/<wi:out var="wi.proj.id"/>/seguranca/alterar_senha.wsp')" role="button" class="botoes ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only" title="Clique no botão para envio de nova senha" alt="Clique no botão para envio de nova senha">
