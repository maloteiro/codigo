...
%><w:initPage name="teste/email"><jsp:useBean
...
/><jsp:setProperty
  name="wipage" property="title" value="Página teste/email"
/></w:initPage><!DOCTYPE html>
<html>
<head>
<title>Página teste/email</title>
...
<body>
<h3>
<p>PROJETO: Plano de comunicação - EBSERH</p>
<p>PÁGINA: Página teste/email</p>
</h3>
