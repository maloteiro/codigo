...
/><jsp:setProperty
  name="upload1" property="condition" value="|tmp.publicar| = publicar && |tmp.arquivo| !="
/><jsp:setProperty
  name="upload1" property="description" value="Upload: UplDoc"
/><jsp:setProperty
  name="upload1" property="id" value="UplDoc"
/><jsp:setProperty
