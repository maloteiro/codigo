...
%><w:initPage name="seguranca/logoff"><jsp:useBean
...
/><jsp:setProperty
  name="wipage" property="title" value="Página seguranca/logoff"
/></w:initPage><!DOCTYPE html>
<html>
<head>
<title>Página seguranca/logoff</title>
...
<body>
<h3>
<p>PROJETO: Sistema Integrado de Gestão Advocatícia </p>
<p>PÁGINA: Página seguranca/logoff</p>
</h3>
