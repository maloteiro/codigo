...
%><w:initPage name="seguranca/perfil/cadastro"><jsp:useBean
...
/><jsp:setProperty
  name="wipage" property="title" value="Cadastro de Perfil de Acesso"
...
<SCRIPT TYPE="text/javascript">
function init(){
document.forms['tmp.edt']['tmp.edt.flg_perfil_status'].checked = ("<wi:out var="tmp.edt.flg_perfil_status"/>" == "1")
}
</SCRIPT>
...
<td><INPUT NAME="tmp.edt.dsc_perfil_nome" ID="tmp.edt.dsc_perfil_nome" MAXLENGTH="45" SIZE="100" VALUE="<wi:out var="tmp.edt.dsc_perfil_nome"/>" CLASS="required field" /></td></tr></table>

<table cellpadding="0" cellspacing="0"><tr>
<td class="label">Sigla:</td>
</tr><tr>
<td><INPUT NAME="tmp.edt.sig_perfil_sigla" ID="tmp.edt.sig_perfil_sigla" MAXLENGTH="4" SIZE="8" VALUE="<wi:out var="tmp.edt.sig_perfil_sigla"/>" CLASS="field" /></td></tr></table>

<table cellpadding="0" cellspacing="0"><tr><td class="label">Ativo:</td>
</tr><tr>
<td style='width:25px'><INPUT NAME="tmp.edt.flg_perfil_status" ID="tmp.edt.flg_perfil_status" VALUE="1" TYPE="Checkbox" /></td></tr></table>
...
<table align="center">
  <tr>
    <td align="center" >
      ...
      <button type="button" name="tmp.btn_pesquisar" id="btn_pesquisar" role="button" class="botoes ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only" title="Clique no botão para pesquisar" alt="Clique no botão para pesquisar" onclick="wiOpen('/<wi:out var="wi.proj.id"/>/seguranca/perfil/pesquisa.wsp');">
