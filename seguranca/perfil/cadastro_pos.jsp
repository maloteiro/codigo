...
/><jsp:setProperty
  name="updateelement1" property="sql" value="INSERT INTO seg_perfil (
	dsc_perfil_nome, 
    sig_perfil_sigla, 
    flg_perfil_status, 
    dat_data_cadastro, 
...
/><jsp:setProperty
  name="updateelement2" property="sql" value="UPDATE seg_perfil
...
/><jsp:setProperty
  name="objectelement1" property="sql" value="SELECT seg_perfil.seq_perfil AS key1
 FROM seg_perfil
 WHERE cod_token_codigo = ?|wi.token|
 ORDER BY seg_perfil.seq_perfil DESC"
/><jsp:setProperty
