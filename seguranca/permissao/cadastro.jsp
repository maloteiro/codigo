...
%><w:initPage name="seguranca/permissao/cadastro"><jsp:useBean
...
/><jsp:setProperty
  name="wipage" property="title" value="Permissões de Acesso"
...
<html>	
  ...
  <SCRIPT TYPE="text/javascript" SRC="/<wi:out var="wi.proj.id"/>/js/wievent.js"></SCRIPT> 
  
  <script>
    
    function seleciona(){
      var doc = document.forms[0];
      wiOpen('/<wi:out var="wi.proj.id"/>/<wi:out var="wi.page.id"/>.wsp?tmp.edt.seq_perfil='+doc['tmp.edt.seq_perfil'].value+'&tmp.edt.seq_modulo='+doc['tmp.edt.seq_modulo'].value);
    }
...
<SCRIPT TYPE="text/javascript">
function init(){
var el = document.getElementsByTagName('SELECT')['tmp.edt.seq_perfil'];
comboSelect(el,'<wi:out var="tmp.edt.seq_perfil"/>');
						...
						<tr>
							<td>
								<div id="div_corpo">
                                  ...
                                  <div class="box">
                                      <center>                                        
										<FORM NAME="Texto2" ACTION="/<wi:out var="wi.proj.id"/>/<wi:out var="wi.page.id"/>.wsp" METHOD="post" CLASS="frm" ><INPUT NAME="wi.page.prev" ID="wi.page.prev" VALUE="<wi:out var="wi.page.id"/>" TYPE="hidden" /><INPUT NAME="wi.token" ID="wi.token" VALUE="<wi:out var="wi.token"/>" TYPE="hidden" />
<table cellpadding="0" cellspacing="0"><tr>
<td class="label">Perfil:</td>
</tr><tr>
<td><SELECT NAME="tmp.edt.seq_perfil" ID="tmp.edt.seq_perfil" CLASS="field" ONCHANGE="seleciona()">
...
<td><SELECT NAME="tmp.edt.seq_modulo" ID="tmp.edt.seq_modulo" CLASS=" field" ONCHANGE="seleciona()">
  <OPTION VALUE="">--Selecione--</OPTION>
  <w:generateCombo name="seg_modulo"/>
</SELECT></td></tr></table>

<br />
<w:generateGrid name="seg_consulta_permissao"/>
