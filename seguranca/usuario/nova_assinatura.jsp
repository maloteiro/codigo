...
%><w:initPage name="seguranca/usuario/nova_assinatura"><jsp:useBean
...
/><jsp:setProperty
  name="wipage" property="title" value="Nova assinatura"
/></w:initPage><!DOCTYPE html>
<html>
<head>
<title>Página seguranca/usuario/nova_assinatura</title>
...
<p>PÁGINA: Página seguranca/usuario/nova_assinatura</p>
  <wi:out />
</h3>
