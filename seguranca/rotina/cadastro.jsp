...
%><w:initPage name="seguranca/rotina/cadastro"><jsp:useBean
...
/><jsp:setProperty
  name="wipage" property="title" value="Cadastro de Funcionalidades"
...
<SCRIPT TYPE="text/javascript">
function init(){
var el = document.getElementsByTagName('SELECT')['tmp.edt.seq_modulo'];
comboSelect(el,'<wi:out var="tmp.edt.seq_modulo"/>');
document.forms['tmp.edt']['tmp.edt.flg_rotina_ativa'].checked = ("<wi:out var="tmp.edt.flg_rotina_ativa"/>" == "S")
}
</SCRIPT>
...
<td><SELECT NAME="tmp.edt.seq_modulo" ID="tmp.edt.seq_modulo" CLASS="required field">
  <OPTION VALUE="">--Selecione--</OPTION>
  <w:generateCombo name="seg_modulo"/>
</SELECT></td></tr></table>

<table cellpadding="0" cellspacing="0"><tr>
<td class="label">Descrição:</td>
</tr><tr>
<td><INPUT NAME="tmp.edt.dsc_rotina_descricao" ID="tmp.edt.dsc_rotina_descricao" MAXLENGTH="255" SIZE="100" VALUE="<wi:out var="tmp.edt.dsc_rotina_descricao"/>" CLASS="required field" /></td></tr></table>

<table cellpadding="0" cellspacing="0"><tr>
<td class="label">Página:</td>
</tr><tr>
<td><INPUT NAME="tmp.edt.dsc_rotina_pagina" ID="tmp.edt.dsc_rotina_pagina" MAXLENGTH="255" SIZE="100" VALUE="<wi:out var="tmp.edt.dsc_rotina_pagina"/>" CLASS="required field" /></td></tr></table>

<table cellpadding="0" cellspacing="0"><tr>
<td class="label">Ordem:</td>
</tr><tr>
<td><INPUT NAME="tmp.edt.num_rotina_ordem" ID="tmp.edt.num_rotina_ordem" MAXLENGTH="13" SIZE="13" VALUE="<wi:out var="tmp.edt.num_rotina_ordem"/>" CLASS="required field"   alt="inteiroSM"/></td></tr></table>

<table cellpadding="0" cellspacing="0"><tr><td class="label">Ativa:</td>
</tr><tr>
<td style='width:25px'><INPUT NAME="tmp.edt.flg_rotina_ativa" ID="tmp.edt.flg_rotina_ativa" VALUE="S" TYPE="Checkbox" /></td></tr></table>
...
<table align="center">
  <tr>
    <td align="center" >
      ...
      <button type="button" name="tmp.btn_pesquisar" id="btn_pesquisar" role="button" class="botoes ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only" title="Clique no botão para pesquisar" alt="Clique no botão para pesquisar" onclick="wiOpen('/<wi:out var="wi.proj.id"/>/seguranca/rotina/pesquisa.wsp');">
