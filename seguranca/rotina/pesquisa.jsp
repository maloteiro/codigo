...
%><w:initPage name="seguranca/rotina/pesquisa"><jsp:useBean
...
/><jsp:setProperty
  name="wipage" property="title" value="Pesquisa de Funcionalidades"
...
<table align="center">
  <tr>
    <td align="center" >      
      <button type="button" name="tmp.btn_add_novo" id="btn_add_novo" role="button" class="botoes ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only" title="Clique no botão para voltar" alt="Clique no botão para voltar" onclick="wiOpen('/<wi:out var="wi.proj.id"/>/seguranca/rotina/cadastro.wsp');">
...
<br>
<w:generateGrid name="seg_consulta_rotina"/>
