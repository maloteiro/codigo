...
%><w:initPage name="seguranca/modulo/cadastro"><jsp:useBean
...
/><jsp:setProperty
  name="wipage" property="title" value="Cadastro de Módulos"
...
<SCRIPT TYPE="text/javascript">
function init(){
document.forms['tmp.edt']['tmp.edt.flg_modulo_ativo'].checked = ("<wi:out var="tmp.edt.flg_modulo_ativo"/>" == "S")
}
</SCRIPT>
...
<td><INPUT NAME="tmp.edt.dsc_modulo_descricao" ID="tmp.edt.dsc_modulo_descricao" MAXLENGTH="150" SIZE="100" VALUE="<wi:out var="tmp.edt.dsc_modulo_descricao"/>" CLASS="required field" /></td></tr></table>

<table cellpadding="0" cellspacing="0"><tr>
<td class="label">Ordem:</td>
</tr><tr>
<td><INPUT NAME="tmp.edt.num_modulo_ordem" ID="tmp.edt.num_modulo_ordem" MAXLENGTH="14" SIZE="14" VALUE="<wi:out var="tmp.edt.num_modulo_ordem"/>" CLASS="field"   alt="inteiroSM"/></td></tr></table>

<table cellpadding="0" cellspacing="0"><tr><td class="label">Ativo:</td>
</tr><tr>
<td style='width:25px'><INPUT NAME="tmp.edt.flg_modulo_ativo" ID="tmp.edt.flg_modulo_ativo" VALUE="S" TYPE="Checkbox" /></td></tr></table>
...
<table align="center">
  <tr>
    <td align="center" >
      ...
      <button type="button" name="tmp.btn_pesquisar" id="btn_pesquisar" role="button" class="botoes ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only" title="Clique no botão para pesquisar" alt="Clique no botão para pesquisar" onclick="wiOpen('/<wi:out var="wi.proj.id"/>/seguranca/modulo/pesquisa.wsp');">
