...
%><w:initPage name="cadastro/responsavel/cadastro"><jsp:useBean
...
/><jsp:setProperty
  name="wipage" property="title" value="Cadastro de Responsáveis"
...
<SCRIPT TYPE="text/javascript">
function init(){
var el = document.getElementsByTagName('SELECT')['tmp.edt.flg_responsavel_ativo'];
comboSelect(el,'<wi:out var="tmp.edt.flg_responsavel_ativo"/>');
}
</SCRIPT>
...
<FORM NAME="tmp.edt" ACTION="/<wi:out var="wi.proj.id"/>/<wi:out var="wi.page.id"/>.wsp" METHOD="post" CLASS="frm"   id="formulario"><INPUT NAME="wi.page.prev" ID="wi.page.prev" VALUE="<wi:out var="wi.page.id"/>" TYPE="hidden" /><INPUT NAME="wi.token" ID="wi.token" VALUE="<wi:out var="wi.token"/>" TYPE="hidden" /><INPUT NAME="tmp.action" ID="tmp.action" VALUE="save" TYPE="hidden" /><INPUT NAME="tmp.id" ID="tmp.id" VALUE="<wi:out var="tmp.id"/>" TYPE="hidden" /><INPUT NAME="tmp.qtd" ID="tmp.qtd" VALUE="<wi:out var="grid.aux_consulta_telefone.size"/>" TYPE="hidden" />
<table cellpadding="0" cellspacing="0"><tr>
<td class="label">Nome:</td>
</tr><tr>
<td><INPUT NAME="tmp.edt.nom_responsavel_nome" ID="tmp.edt.nom_responsavel_nome" MAXLENGTH="255" SIZE="60" VALUE="<wi:out var="tmp.edt.nom_responsavel_nome"/>" CLASS="field required" /></td></tr></table>

<table cellpadding="0" cellspacing="0"><tr>
<td class="label">E-mail:</td>
</tr><tr>
<td><INPUT NAME="tmp.edt.dsc_responsavel_email" ID="tmp.edt.dsc_responsavel_email" MAXLENGTH="255" SIZE="60" VALUE="<wi:out var="tmp.edt.dsc_responsavel_email"/>" CLASS="field email" /></td></tr></table>
<table cellpadding='0' cellspacing='0' class='tabLine'><tr>
<td class="label">
<w:generateGrid name="aux_consulta_telefone"/>
</td></tr></table>
...
<td><SELECT NAME="tmp.edt.flg_responsavel_ativo" ID="tmp.edt.flg_responsavel_ativo" CLASS="field required">
...
<table align="center" width="100%">
  <tr>
    <td align="center" >
      ...
      <button type="button" name="tmp.btn_pesquisar" id="btn_pesquisar" role="button" class="botoes ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only" title="Clique no botão para pesquisar" alt="Clique no botão para pesquisar" onclick="wiOpen('/<wi:out var="wi.proj.id"/>/cadastro/responsavel/pesquisa.wsp');">
