...
%><w:initPage name="cadastro/vaga/cadastro"><jsp:useBean
...
/><jsp:setProperty
  name="wipage" property="title" value="Cadastro de Vagas"
...
<SCRIPT TYPE="text/javascript">
function init(){
var el = document.getElementsByTagName('SELECT')['tmp.edt.tip_vaga_tipo'];
comboSelect(el,'<wi:out var="tmp.edt.tip_vaga_tipo"/>');
var el = document.getElementsByTagName('SELECT')['tmp.edt.flg_vaga_ativa'];
comboSelect(el,'<wi:out var="tmp.edt.flg_vaga_ativa"/>');
}
</SCRIPT>
...
<FORM NAME="tmp.edt" ACTION="/<wi:out var="wi.proj.id"/>/<wi:out var="wi.page.id"/>.wsp" METHOD="post" CLASS="frm"   id="formulario"><INPUT NAME="wi.page.prev" ID="wi.page.prev" VALUE="<wi:out var="wi.page.id"/>" TYPE="hidden" /><INPUT NAME="wi.token" ID="wi.token" VALUE="<wi:out var="wi.token"/>" TYPE="hidden" /><INPUT NAME="tmp.action" ID="tmp.action" TYPE="hidden" /><INPUT NAME="tmp.id" ID="tmp.id" VALUE="<wi:out var="tmp.id"/>" TYPE="hidden" />
<table cellpadding="0" cellspacing="0"><tr>
<td class="label">Título:</td>
</tr><tr>
<td><INPUT NAME="tmp.edt.dsc_vaga_titulo" ID="tmp.edt.dsc_vaga_titulo" MAXLENGTH="255" SIZE="60" VALUE="<wi:out var="tmp.edt.dsc_vaga_titulo"/>" CLASS="field required" /></td></tr></table>

<table cellpadding="0" cellspacing="0"><tr>
<td class="label">E-mail:</td>
</tr><tr>
<td><INPUT NAME="tmp.edt.dsc_vaga_email" ID="tmp.edt.dsc_vaga_email" MAXLENGTH="255" SIZE="60" VALUE="<wi:out var="tmp.edt.dsc_vaga_email"/>" CLASS="field required email" /></td></tr></table>

<table cellpadding="0" cellspacing="0"><tr>
<td class="label">Descrição:</td>
</tr><tr>
<td><TEXTAREA NAME="tmp.edt.txt_vaga_descricao" ID="tmp.edt.txt_vaga_descricao" COLS="60" ROWS="10" CLASS="field required"><wi:out var="tmp.edt.txt_vaga_descricao"/></TEXTAREA></td></tr></table>

<table cellpadding="0" cellspacing="0"><tr>
<td class="label">Salário:</td>
</tr><tr>
<td><INPUT NAME="tmp.edt.num_vaga_salario" ID="tmp.edt.num_vaga_salario" MAXLENGTH="13" SIZE="13" VALUE="<wi:out var="tmp.edt.num_vaga_salario"/>" CLASS="field required"  alt="decimal"/></td></tr></table>

<table cellpadding="0" cellspacing="0"><tr>
<td class="label">Tipo de Vaga:</td>
</tr><tr>
<td><SELECT NAME="tmp.edt.tip_vaga_tipo" ID="tmp.edt.tip_vaga_tipo" CLASS="field required">
  <OPTION VALUE="">--Selecione--</OPTION>
  <w:generateCombo name="aux_tipo_vaga"/>
</SELECT></td></tr></table>

<table cellpadding="0" cellspacing="0"><tr>
<td class="label">Data:</td>
</tr><tr>
<td><INPUT NAME="tmp.edt.dat_vaga_data" ID="tmp.edt.dat_vaga_data" MAXLENGTH="10" SIZE="10" VALUE="<wi:function expr="df(|tmp.edt.dat_vaga_data|,FMT,yyyy-MM-dd,dd/MM/yyyy)"/>" CLASS="field required"   alt="dateBR"/></td></tr></table>

<table cellpadding="0" cellspacing="0"><tr>
<td class="label">Ativa:</td>
</tr><tr>
<td><SELECT NAME="tmp.edt.flg_vaga_ativa" ID="tmp.edt.flg_vaga_ativa" CLASS="field required">
  <OPTION VALUE="">--Selecione--</OPTION>
...
<table align="center">
  <tr>
    <td align="center" >
      ...
      <button type="button" name="tmp.btn_pesquisar" id="btn_pesquisar" role="button" class="botoes ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only" title="Clique no botão para pesquisar" alt="Clique no botão para pesquisar" onclick="wiOpen('/<wi:out var="wi.proj.id"/>/cadastro/vaga/pesquisa.wsp');">
