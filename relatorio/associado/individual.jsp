...
%><w:initPage name="relatorio/associado/individual"><jsp:useBean
...
/><jsp:setProperty
  name="wipage" property="title" value="individual"
/></w:initPage><!DOCTYPE html>
<html>
<head>
<title>Página relatorio/associado/individual</title>
...
<body>
<h3>
<p>PROJETO: Cadastro de Associado - MultiLife</p>
<p>PÁGINA: Página relatorio/associado/individual</p>
</h3>
