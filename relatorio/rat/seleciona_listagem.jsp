...
%><w:initPage name="relatorio/rat/seleciona_listagem"><jsp:useBean
...
/><jsp:setProperty
  name="wipage" property="title" value="Relatório de Atendimento Técnico por Situação"
