...
/><jsp:setProperty
  name="report1" property="description" value="Report: rel_rat_orgao"
/><jsp:setProperty
  name="report1" property="id" value="rel_rat_orgao"
/><w:setPropertyByMethod
  name="report1" method="reportParameter" arg1="tmp.seq.local" arg2="|tmp.seq_local|"
/><w:executeCore
