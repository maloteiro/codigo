...
%><w:initPage name="publico/comunicacao_backup"><jsp:useBean
...
/><jsp:setProperty
  name="wipage" property="title" value="Comunicação"
...
<html lang="pt">
  <head>
    ...
    <title>Plano de Comunicação - EBSERH</title>
  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="row">
      		<div class="col-lg-12">
              <h3><strong>HOST / SERVIÇO: <wi:out var="tmp.serv.nom_servidor_nome"/></strong></h3>
      			<div class="well">
              ...
              <h3>1. Descrição geral do servidor / serviço</h3>
        		<div class="well">
        		<h4><wi:out var="tmp.serv.txt_servidor_descricao"/></h4>
        		</div>
        		
        		<h3>2. Informações técnicas</h3>
        		<div class="well">
                  <wi:function expr="if(|tmp.serv.tip_servidor_tipo|==S,
                  <h4>        			
                      <div><strong>Sistema Operacional:</strong> |tmp.serv.dsc_sistema_descricao|</div>
                      <div><strong>Rede:</strong> |tmp.serv.dsc_servidor_rede|</div>
                  ...
                  <h4>        			
                    ...
                    <div><strong>Rede:</strong> |tmp.serv.dsc_servidor_rede|</div>
                    <div><strong>Nome DNS / Endereço:</strong> |tmp.serv.nom_servidor_nome_dns|</div>
        		...
        		<h3>3. Potenciais riscos deste serviço</h3>
        		<div class="well">
        		<h4>
        		...
        		<h3>4. Matriz de Impacto/Urgência</h3>
        		<div class="well">
        		<h4>
        			<div>
        			...
        			<div>
                      <strong>Urgência:</strong> <wi:function expr="if(|tmp.serv.flg_servidor_urgencia|==A,
                      								<span class=\"label label-danger\">Alta</span>,
                      								|$if(|tmp.serv.flg_servidor_impacto|==M,
                      									<span class=\"label label-warning\">Média</span>,
                      									<span class=\"label label-info\">Baixa</span>
        		...
        		<h3>5. Atuação do NOC</h3>
        		<div class="well">
        		<h4>
                  <div><strong>Possível solução de incidentes pelo NOC:</strong> <wi:function expr="if(|tmp.serv.flg_servidor_atuacao_noc|==S,<span class=\"label label-success\">SIM</span>,<span class=\"label label-danger\">NÃO</span>)"/></div>
        			<br />
        		...
        		<h3>5.1 Processo de escalação dos eventos</h3>
      			...
      			<div class="row">
       			...
       			<div class="page-header">
        			<div class="alert alert-warning" role="alert">
        				<button type="button" class="btn btn-lg btn-warning">Média e Atenção</button>
      				</div>
      			</div>
      			<div class="row">
        			<div class="col-md-12">
