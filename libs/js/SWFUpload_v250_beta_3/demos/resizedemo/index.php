...
<script type="text/javascript">
		...
		window.onload = function () {
			swfu = new SWFUpload({
				...
				file_types_description : "JPG Imagens; PNG Imagens; GIF Imagens",
				file_upload_limit : 0,
				...
				button_width: 180,
				button_height: 18,
				button_text : '<span class="button">Carregar imagens <span class="buttonSmall">(2 MB Max)</span></span>',
...
<div id="content">
	...
	<div id="thumbnails">
		<?php
			...
			$dir = new DirectoryIterator("saved");
			foreach ($dir as $fileinfo) {
				if (!$fileinfo->isDot() && $fileinfo->isFile()) {
				 	$arquivo = explode(".",$fileinfo->getFilename());
					if($arquivo[1]!="php"){
						echo '<img style="margin: 5px; vertical-align: middle;" src="saved/' . $fileinfo->getFilename() . '" />';
					}
				}
			}
		?>
